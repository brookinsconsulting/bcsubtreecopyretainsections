...
<?php
/**
 * File containing the bcsubtreecopyretainsections.php script.
 *
...
/**
 * Subtree Copy (optional, retain existing object sections) Script
 * file  bin/php/bcsubtreecopyretainsections.php
 *
 * Based on the default, 'Subtree Copy Script'
 * file  bin/php/ezsubtreecopy.php
 * Reference: https://github.com/ezsystems/ezpublish/blob/master/bin/php/ezsubtreecopy.php
 */
                                   ...
                                   $allVersions = false, $keepCreator = false, $keepTime = false )
{
    ...
    // START EDIT BC: bcsubtreecopyretainsections
    //
    // Should we should reset section that will be updated in updateSectionID(). ?

    if ( $retainSections == true )
    {
